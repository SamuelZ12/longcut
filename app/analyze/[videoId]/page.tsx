...
import { saveNote } from "@/lib/notes-client";
...
export default function AnalyzePage() {
      ...
      try {
        ...
        backgroundOperation(
          ...
          async () => {
            ...
            // Silently fail for anonymous users - this is expected behavior
            await backgroundOperation("update-questions", async () => {
              try {
                await csrfFetch.post("/api/update-video-analysis", {
                  videoId: extractedVideoId,
                  suggestedQuestions: normalizedQuestions,
                });
              } catch (error) {
                // Silently ignore all errors - anonymous users cannot update
                // This is expected and should not throw errors
              }
            });
  ...
  useEffect(() => {
    ...
    // MVP: Notes functionality disabled
